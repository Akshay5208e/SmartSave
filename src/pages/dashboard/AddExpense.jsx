...
function Expenses() {
  ...
  const categories = ["Groceries", "Education", "Health", "Subscriptions", "Takeaways", "Clothing", "Travelling","Other"];
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getExpenseData(timeOption, categoryOption);
        setIncomeArray(data);
      } catch (error) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const data = await getExpenseData(timeOptionPC, categoryOptionPC);
        const totalIncomeByCategory = calculateTotalIncomeByCategory(data, categories);
          ...
          >
            <div>
              ...
              <Typography
                ...
                className="flex items-center pt-2 gap-1 font-normal text-blue-gray-600"
              >
                Chart Representaion of Your Expenses
              </Typography>
            </div>
          ...
          <tbody>
           {
              ...
              <tr key={key}>
                  ...
                  <td className='py-3 px-5 border-b border-blue-gray-50'>  <Typography variant="medium" color="red"className="font-bold">- ₹{income.amount}</Typography></td>
